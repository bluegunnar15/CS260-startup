...
const Question = require('./public/Question.js');
...
function generateFakeQuestions() {
    ...
    let tmp = new Question("ninethQuestion", "Matthew Marino", getComments(), getLargeNumber(), getLargeNumber(), getSmallNumber());
